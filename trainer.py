...
class Trainer:
    def __init__(self, model_path, epochs=20, train_dir="data/train.csv", batch_size=16):
        ...
        # self.model = CNNbiLSTM(input_dim=64, hidden_size=128, num_vocabs=13)
        ...
        self.wandb = wandb.init(project="biLSTM")
